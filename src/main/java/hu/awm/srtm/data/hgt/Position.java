...
/**
 * Represents a cell in a {@link Tile}.
 * Supports navigation via the {@link #get(Position, double, int)} method.
 */
public class Position {
	...
	public static Position get(Position coordinates, double deg, int distance) {
